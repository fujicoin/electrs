...
An efficient re-implementation of Electrum Server, inspired by [ElectrumX](https://github.com/kyuupichan/electrumx), [Electrum Personal Server](https://github.com/chris-belcher/electrum-personal-server) and [fujicoincore-indexd](https://github.com/jonasschnelli/fujicoincore-indexd).

The motivation behind this project is to enable a user to run his own Electrum server,
with required hardware resources not much beyond those of a [full node](https://en.fujicoin.it/wiki/Full_node#Why_should_you_use_a_full_node_wallet).
The server indexes the entire Fujicoin blockchain, and the resulting index enables fast queries for any given user wallet,
 ...
 * Fast synchronization of the Fujicoin blockchain (~2 hours for ~187GB @ July 2018) on [modest hardware](https://gist.github.com/romanz/cd9324474de0c2f121198afe3d063548)
 ...
 * [`txindex`](https://github.com/fujicoinbook/fujicoinbook/blob/develop/ch03.asciidoc#txindex) is not required for the Fujicoin node
